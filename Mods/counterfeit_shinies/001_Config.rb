module CounterfeitShinies
  ...
  module Config
    ...
    WORLD_OFFER_IMMEDIATE_CALL_THRESHOLD = 10
    WORLD_OFFER_ANGER_THRESHOLD = 34
    WORLD_OFFER_DECLINE_THRESHOLD = 72
    WORLD_OFFER_HEAT_GAIN = 28
    WORLD_OFFER_STEP_GAIN = 150
    WORLD_OFFER_IMMEDIATE_HEAT_GAIN = 54
    WORLD_OFFER_IMMEDIATE_STEP_GAIN = 240
    WORLD_OFFER_EVENT_COOLDOWN_SECONDS = 4
    WORLD_OFFER_REPEAT_STREAK_REQUIRED = 3
    WORLD_OFFER_MULTI_BUY_CHANCE = 30
    ...
    LOSS_HEAT_RESET = 0
    HEAT_CAP = 120
    BASE_STEP_THRESHOLD = 220
    BADGE_STEP_REDUCTION = 3
    EXTRA_COUNTERFEIT_STEP_REDUCTION = 10
    VALUE_STEP_REDUCTION_DIVISOR = 4500
    MIN_STEP_THRESHOLD = 80
    BASE_ENCOUNTER_CHANCE = 10
    HEAT_ENCOUNTER_CHANCE_STEP = 2
    BADGE_ENCOUNTER_CHANCE_STEP = 1
    VALUE_ENCOUNTER_CHANCE_DIVISOR = 8000
    MAX_ENCOUNTER_CHANCE = 58
    ...
    ENFORCER_CHASE_CHARSETS = ["BWDoctor"]
